...
_STAGES = [
    ...
    # Read-only compatibility for task histories created before the planning
    # agents were merged into GameplayPlanningAgent.
    ...
    ("DesignContractCompilerAgent", "design_contract", "冻结设计合同"),
    ("ContractGateAgent", "contract_gate", "校验设计合同"),
    ("AssetAgent", "asset_processing", "整理素材"),
    ("GameAssetGenerationAgent", "asset_generation", "生成游戏素材"),
    ("GameCodeAgent", "code_generation", "生成游戏代码"),
    ("ProjectBuildAgent", "project_build", "构建运行时"),
    ("BuildValidateAgent", "build_validation", "测试游戏是否可运行"),
    ("GameCodeAgentRepair", "repair_code", "自动修复构建问题"),
    ("GameDesignAgentReplan", "replan_game_design", "调整设计方案"),
...
_REVISION_STAGES = [
    ...
    ("DesignContractCompilerAgent", "design_contract", "冻结设计合同"),
    ("ContractGateAgent", "contract_gate", "校验设计合同"),
    ("AssetAgent", "asset_processing", "整理修改素材"),
    ("GameAssetGenerationAgent", "asset_generation", "生成修改素材"),
    ("CodeRevisionAgent", "code_revision", "修改现有代码"),
    ("ProjectBuildAgent", "project_build", "构建运行时"),
    ("BuildValidateAgent", "build_validation", "验证修改结果"),
    ("CodeRevisionRepairAgent", "revision_repair", "修复版本构建"),
    ("GameplayQAAgent", "gameplay_qa", "回归测试玩法"),
    ("GameplayRepairAgent", "gameplay_repair", "修复回归玩法"),
...
_REMIX_STAGES = [
    ...
    ("DesignContractCompilerAgent", "design_contract", "冻结设计合同"),
    ("ContractGateAgent", "contract_gate", "校验设计合同"),
    ("AssetAgent", "asset_processing", "整理 Remix 素材"),
    ("GameAssetGenerationAgent", "asset_generation", "生成 Remix 素材"),
    ("CodeRevisionAgent", "code_revision", "改造源游戏文件"),
    ("ProjectBuildAgent", "project_build", "构建 Remix 运行时"),
    ("BuildValidateAgent", "build_validation", "验证 Remix 构建"),
    ("CodeRevisionRepairAgent", "revision_repair", "修复 Remix 构建"),
    ("GameplayQAAgent", "gameplay_qa", "测试 Remix 玩法"),
    ("GameplayRepairAgent", "gameplay_repair", "修复 Remix 玩法"),
...
_PROGRESS = {
    ...
    "memory_retrieval": 14,
    "intent_spec": 18,
    "gameplay_planning": 30,
    # Retained for summaries from tasks created before the planning merge.
    "brief_expansion": 24,
    "mechanic_planner": 30,
    "archetype_router": 34,
    "game_design": 50,
    ...
    "build_validation": 82,
    "repair_code": 84,
    "replan_game_design": 70,
    "gameplay_qa": 90,
    "gameplay_repair": 88,
    "publish_artifact": 96,
    "feedback_understanding": 25,
    "code_revision": 55,
    "revision_repair": 65,
    "publish_revision": 96,
    "publish_remix": 96,
